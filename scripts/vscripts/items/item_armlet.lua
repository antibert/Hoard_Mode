...
================================================================================================================= ]]
function item_bfury_datadriven_active_on_spell_start(keys)
	keys.caster:EmitSound("DOTA_Item.Armlet.DeActivate")
	swap_to_item(keys, "item_bfury_datadriven")
end
...
================================================================================================================= ]]
function item_bfury_datadriven_on_spell_start(keys)
	...
	for i=0, 5, 1 do
		local current_item = keys.caster:GetItemInSlot(i)
		if current_item ~= nil then
			if current_item:GetName() == "item_bfury_datadriven_active" then
				keys.caster:RemoveItem(current_item)
	...
	swap_to_item(keys, "item_bfury_datadriven_active")  --Turn the newly toggled armlet on.
end
...
================================================================================================================= ]]
function modifier_item_bfury_datadriven_active_on_interval_think_damage(keys)
...
================================================================================================================= ]]
function modifier_item_bfury_datadriven_active_apply_tick_strength_on_interval_think(keys)
	if keys.ability.ArmletTicksActive == nil or keys.ability.ArmletTicksActive < keys.UnholyTicksToFullEffect then
		keys.ability:ApplyDataDrivenModifier(keys.caster, keys.caster, "modifier_item_bfury_datadriven_active_tick", {duration = -1})
...
--[[ ============================================================================================================
	...
	Additional parameters: keys.UnholyTicksToFullEffect and keys.UnholyBonusStrength
================================================================================================================= ]]
function item_bfury_datadriven_active_on_unequip(keys)
	if keys.ability.ArmletTicksActive ~= nil then
		
		for i=1, keys.ability.ArmletTicksActive, 1 do
			keys.caster:RemoveModifierByName("modifier_item_bfury_datadriven_active_tick")
		end
		for i=1, keys.ability.ArmletTicksActive, 1 do
