...
================================================================================================================= ]]
function item_shivas_guard_2_on_spell_start(keys)
		...
		callback = function()
			...
			for i, individual_unit in ipairs(nearby_enemy_units) do
				if not individual_unit:HasModifier("modifier_item_shivas_guard_2_blast_debuff") then
					...
					keys.ability:ApplyDataDrivenModifier(keys.caster, individual_unit, "modifier_item_shivas_guard_2_blast_debuff", nil)
				end
			end
